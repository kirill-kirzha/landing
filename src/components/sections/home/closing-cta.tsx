...
export function ClosingCtaSection({ className }: SectionProps) {
  return (
    <section className={cn("relative flex min-h-[60vh] items-center justify-center py-28 sm:py-36", className)}>
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_110%,oklch(0.93_0.015_82/0.4),transparent)]" aria-hidden="true" />
      ...
      >
        ...
        <div className="gradient-desert-mint mx-auto mt-8 h-px w-24 rounded-full" aria-hidden="true" />
